    ...
    <div className="bg-gradient-to-r from-primary to-secondary dark:from-slate-900 dark:to-slate-800 text-white py-12 md:py-20 lg:py-32 min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 md:px-6 flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-8 relative z-10">
        <div className="lg:w-1/2 text-center lg:text-left mb-6 lg:mb-0">
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-4 md:mb-6 glow-text" data-aos="fade-right" data-aos-duration="400">
          ...
          <p className="text-base md:text-lg lg:text-xl mb-6 md:mb-8 leading-relaxed text-gray-100 dark:text-gray-200" data-aos="fade-right" data-aos-delay="200" data-aos-duration="400">
        ...
        <div className="lg:w-1/2 flex justify-center w-full" data-aos="zoom-in" data-aos-delay="300" data-aos-duration="500">
          <img
