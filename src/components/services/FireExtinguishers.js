  ...
  return (
    <div className="service-page relative overflow-hidden bg-gradient-to-r from-primary to-secondary dark:from-gray-900 dark:to-black min-h-screen py-12 md:py-16">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="service-page-card bg-gradient-to-br from-teal-100 to-blue-100 dark:from-slate-900 dark:to-slate-800 p-6 md:p-8 rounded-lg md:rounded-xl shadow-lg glow-box" data-aos="fade-up" data-aos-duration="300">
