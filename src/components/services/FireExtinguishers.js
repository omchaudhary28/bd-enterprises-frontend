...
const FireExtinguishers = () => {
  ...
  const standards = [
    { icon: '📋', title: 'NFPA 10', description: 'National Fire Protection Association standard for portable fire extinguishers and systems' },
    { icon: '🛡️', title: 'NFPA 12', description: 'Standards for CO2 extinguishing systems including safe discharge and operational procedures' },
    { icon: '✓', title: 'OSHA Compliance', description: 'Workplace fire safety regulations and annual inspection documentation requirements' }
  ];
