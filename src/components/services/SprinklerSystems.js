  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-primary via-blue-700 to-secondary dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 min-h-screen">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 py-12 md:py-20">
        <PageHero
          badge="Automatic Suppression Systems"
          title="Sprinkler & Suppression Systems"
          subtitle="The Gold Standard in Fire Protection"
          description="Automatic sprinkler systems are the most effective method for controlling fires before they spread. We design, install, and maintain high-performance systems for every building type, from warehouses to office parks, minimizing water damage while maximizing life safety and property protection."
          backTo="/services"
        />
