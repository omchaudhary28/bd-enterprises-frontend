  ...
  return (
    <div className="service-page relative overflow-hidden bg-gradient-to-r from-primary to-secondary dark:from-gray-900 dark:to-black min-h-screen py-12 md:py-16">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary dark:text-white mb-6 text-center glow-text" data-aos="fade-down" data-aos-duration="300">Emergency Lighting & Exit Signage</h1>
