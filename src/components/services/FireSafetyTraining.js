  ...
  return (
    <div className="service-page relative overflow-hidden bg-gradient-to-r from-primary to-secondary dark:from-gray-900 dark:to-black min-h-screen py-12 md:py-16">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary dark:text-white mb-6 text-center glow-text" data-aos="fade-down" data-aos-duration="300">Fire Safety Training & Awareness</h1>
        ...
        <div className="service-section-card mb-10 bg-gradient-to-r from-blue-50 to-teal-50 dark:from-gray-900 dark:to-black p-4 sm:p-6 md:p-8 rounded-lg border border-blue-200 dark:border-slate-700">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-primary dark:text-white mb-4 text-center" data-aos="fade-down" data-aos-duration="300">Training Programs We Offer</h2>
