  ...
  return (
    <div className="container mx-auto p-4 py-16">
      <div className="bg-gradient-to-br from-teal-100 to-blue-100 p-8 rounded-lg shadow-lg" data-aos="fade-up" data-aos-duration="400">
        <h1 className="text-4xl font-bold text-primary mb-6 text-center" data-aos="fade-down" data-aos-duration="400">Cloud Computing Solutions</h1>
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-bold text-vibrant-purple mb-5 text-center" data-aos="fade-down" data-aos-delay="100" data-aos-duration="400">Our Cloud Services</h2>
