    ...
    <div className="container mx-auto p-4 py-16">
      <div className="bg-gradient-to-br from-teal-100 to-blue-100 p-8 rounded-lg shadow-lg" data-aos="fade-up" data-aos-duration="700">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-8" data-aos="fade-up" data-aos-delay="200" data-aos-duration="700">
          ...
          <div className="md:w-1/2" data-aos="zoom-in" data-aos-delay="300" data-aos-duration="800">
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-bold text-vibrant-green mb-5 text-center" data-aos="fade-down" data-aos-delay="100" data-aos-duration="700">Our Technology Stack</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="flex items-start" data-aos="fade-right" data-aos-delay="100" data-aos-duration="700">
            ...
            <div className="flex items-start" data-aos="fade-left" data-aos-delay="100" data-aos-duration="700">
              <div>
            ...
            <div className="flex items-start" data-aos="fade-right" data-aos-delay="200" data-aos-duration="700">
            ...
            <div className="flex items-start" data-aos="fade-left" data-aos-delay="200" data-aos-duration="700">
              <div>
        ...
        <div className="text-center mt-10">
          <Link to="/contact" className="bg-vibrant-green text-white px-4 py-2 sm:px-6 sm:py-3 rounded-full text-sm sm:text-base font-semibold hover:bg-opacity-90 transition-colors duration-300 shadow-lg">
            Contact Us
          </Link>
        </div>
      </div>
