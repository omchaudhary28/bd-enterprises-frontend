  ...
  return (
    <div className="container mx-auto p-4 py-16">
      <div className="bg-gradient-to-br from-teal-100 to-blue-100 p-8 rounded-lg shadow-lg" data-aos="fade-up" data-aos-duration="800">
        <h1 className="text-4xl font-bold text-primary mb-6 text-center" data-aos="fade-down" data-aos-duration="800">Mobile Application Development</h1>
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-bold text-vibrant-orange mb-5 text-center" data-aos="fade-down" data-aos-delay="100" data-aos-duration="800">Our Mobile Expertise</h2>
        ...
        <div className="text-center mt-10">
          <Link to="/contact" className="bg-vibrant-orange text-white px-8 py-4 rounded-full text-xl font-semibold hover:bg-opacity-90 transition-colors duration-300 shadow-lg">
